...
export const TOPICS: Topic[] = [
  { key: 'gohan', prompt: '今日のご飯', seed: 'meal' },
  { key: 'sora', prompt: '今日の空', seed: 'sky' },
  { key: 'nomimono', prompt: '今日の飲みもの', seed: 'drink' },
  { key: 'desk', prompt: 'いま机の上にあるもの', seed: 'desk' },
  { key: 'ashimoto', prompt: '今日の足もと', seed: 'feet' },
  { key: 'oyatsu', prompt: '今日のおやつ', seed: 'snack' },
  { key: 'mado', prompt: '窓の外、どんな感じ？', seed: 'window' },
  { key: 'sabori', prompt: '今日のサボりスポット', seed: 'lazy' },
  { key: 'reizoko', prompt: '冷蔵庫、なに入ってる？', seed: 'fridge' },
  { key: 'gohobi', prompt: '今日のごほうび', seed: 'reward' },
  { key: 'temoto', prompt: 'いまの手もと', seed: 'hand' },
  { key: 'shoumona', prompt: '今日のしょうもないやつ', seed: 'silly' },
  { key: 'iro', prompt: 'いまの気分を色で', seed: 'color' },
  { key: 'yashoku', prompt: '深夜のおとも（夜食）', seed: 'midnight' },
  { key: 'omotomo', prompt: '作業のおとも', seed: 'work' },
  { key: 'konbini', prompt: '今日のコンビニ戦利品', seed: 'conv' },
];
